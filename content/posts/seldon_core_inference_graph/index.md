...
date: 2022-12-01T21:13:24+07:00
...
hidemeta: false
comments: false
description: "Compose multi-step inference graphs (transformers, combiners, routers) with Seldon Core."
summary: "Compose multi-step inference graphs (transformers, combiners, routers) with Seldon Core."
disableHLJS: false
disableShare: false
hideSummary: false
searchHidden: false
...
1. Create namespace `seldon-model` and setup an istio gateway
...
1. Create a `seldon-system` namespace and install Seldon Core.
...
1. Run inference pipeline from manifest
...
You can get full source code [here](https://github.com/hoangph3/mlops-labs/tree/main/seldon-core-serving/inference-graph)!
