---
title: "Scheduling Services with HashiCorp Nomad"
date: 2024-08-19T00:47:20+07:00
tags: ["Nomad", "DevOps"]
author: ["hoangph3"]
showToc: true
TocOpen: false
...
hidemeta: false
comments: false
description: "Deploy and orchestrate containerized services using HashiCorp Nomad and Consul."
summary: "Deploy and orchestrate containerized services using HashiCorp Nomad and Consul."
disableHLJS: false
disableShare: false
hideSummary: false
searchHidden: false
...
![Alt text](consul_status.png)

Nomad status:

![Alt text](nomad_status.png)

1. Access the UI with ACL:

Consul UI:

![Alt text](consul_ui.png)

Nomad UI:

![Alt text](nomad_ui.png)
...
1. Create `nginx.hcl` job, get `nginx.conf` from consul with template stanza:
...
1. Bind mount `nginx.conf` to containers:
...
Go to the brower: [http://example-nginx.service.demo:8082](http://example-nginx.service.demo:8082)

![Alt text](nginx_service.png)
...
![Alt text](flask_app_container.png)

Go to the brower: [http://app-nginx.service.demo](http://app-nginx.service.demo)

![Alt text](flask_app.png)

It’s working.

You can get full source code [here](https://github.com/hoangph3/devops-tutorial/tree/main/nomad)!
