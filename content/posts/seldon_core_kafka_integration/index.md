...
hidemeta: false
comments: false
description: "Stream predictions in and out of Seldon Core model deployments using Kafka."
summary: "Stream predictions in and out of Seldon Core model deployments using Kafka."
disableHLJS: false
disableShare: false
hideSummary: false
searchHidden: false
...
1. Make a prediction after the Seldon Deployment is available via the ingress gateway:
...
1. Deploy another mnist model with kafka:
...
1. Send real time data for stream processing, then check the data processed:
...
You can get full source code [here](https://github.com/hoangph3/mlops-labs/tree/main/seldon-core-serving/kafka-integration)!
