...
hidemeta: false
comments: false
description: "Explore how TensorFlow Serving handles different request content types for inference."
summary: "Explore how TensorFlow Serving handles different request content types for inference."
disableHLJS: false
disableShare: false
hideSummary: false
searchHidden: false
...
These helpers are mainly shaped as *“codecs”*.
That is, abstractions which know how to *“encode”* and *“decode”* arbitrary Python datatypes to and from the V2 Inference Protocol.
...
You can get full source code [here](https://github.com/hoangph3/mlops-labs/tree/main/ml-serving/content-type)!
