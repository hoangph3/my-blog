...
hidemeta: false
comments: false
description: "Send and parse JSON prediction requests against a TensorFlow Serving model."
summary: "Send and parse JSON prediction requests against a TensorFlow Serving model."
disableHLJS: false
disableShare: false
hideSummary: false
searchHidden: false
...
For that, we will first implement an extension which serve as the *runtime* to perform inference using our custom `Hello World JSON` model.
...
You can get full source code [here](https://github.com/hoangph3/mlops-labs/tree/main/ml-serving/json-model)!
