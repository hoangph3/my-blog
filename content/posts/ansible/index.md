...
hidemeta: false
comments: false
description: "Automate server provisioning and configuration with Ansible playbooks and roles."
summary: "Automate server provisioning and configuration with Ansible playbooks and roles."
disableHLJS: false
disableShare: false
hideSummary: false
searchHidden: false
...
You can get full source code [here](https://github.com/hoangph3/devops-tutorial/tree/main/ansible)!
